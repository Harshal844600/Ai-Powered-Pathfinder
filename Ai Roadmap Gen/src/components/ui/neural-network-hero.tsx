...
// import { SplitText } from 'gsap/SplitText'; // NOTE: SplitText is a paid Club GSAP plugin. Using standard animation for text to avoid licensing issues requiring a paid key.
...
export default function NeuralNetworkHero({
    ...
    useGSAP(
        () => {
            ...
            // SplitText is a paid plugin. Fallback to simple animation.
            // If the user has SplitText, they can uncomment the proper imports and logic.
            /*
    ...
    return (
        <section ref={sectionRef} className="relative min-h-screen w-full overflow-hidden">
            ...
            <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 pb-24 pt-36 sm:gap-8 sm:pt-44 md:px-10 lg:px-16">
                ...
                <div ref={ctaRef} className="flex flex-wrap items-center gap-3 pt-2 w-full max-w-xl">
                    ...
                    {/* Allow injecting custom content like input forms here */}
                    {children}
                </div>
